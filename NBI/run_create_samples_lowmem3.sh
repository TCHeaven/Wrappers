...
cat fasta.fa | while IFS= read -r line; do
  ...
  mkdir ${OutDir}/hom3/${scaffold_name}
  singularity exec /jic/scratch/groups/Saskia-Hogenhout/tom_heaven/containers/python3.sif python3 /hpc-home/did23faz/git_repos/Scripts/NBI/create_sample_sequences4.py ${scaffold_name}.vcf.gz ${scaffold_name}.fa ${OutDir}/hom/${scaffold_name}
done
